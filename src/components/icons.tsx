...
export function IconFlame(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        d="M13 2s.2 2.9-1.5 4.7C9.9 8.2 8 9.5 8 12.3c0 3 2.3 5.7 6 5.7 3.3 0 6-2.2 6-6 0-4.1-3.4-6.2-7-10Z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinejoin="round"
      />
      <path
        d="M12.5 10.3c-.7 1.1-2.5 2-2.5 3.7 0 1.6 1.2 3 3.2 3 1.7 0 3.3-1.2 3.3-3.3 0-2.1-1.8-3.2-4-3.4Z"
        fill="currentColor"
        opacity="0.25"
      />
    </svg>
...
export function IconLightning(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        d="M4.2 0 0 7.2h3L2.8 13 7 5.8H4L4.2 0Z"
        fill="currentColor"
      />
    </svg>
  );
...
export function IconWallet(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        d="M4 7a3 3 0 0 1 3-3h11a2 2 0 0 1 2 2v2"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
      <path
        d="M4 9v9a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-3"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
      <path
        d="M20 10h-4a2 2 0 0 0 0 4h4v-4Z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinejoin="round"
      />
